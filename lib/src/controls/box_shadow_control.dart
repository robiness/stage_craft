...
class BoxShadowControl extends ValueControl<BoxShadow> {
  ...
  late final TextEditingController _offsetXController = 
      TextEditingController(text: value.offset.dx.toString());
  late final TextEditingController _offsetYController = 
      TextEditingController(text: value.offset.dy.toString());
